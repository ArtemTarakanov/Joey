                ...
                <div className="flex flex-col items-center justify-center gap-8 max-md:flex-row max-md:justify-between max-md:w-full">
                    ...
                    <motion.ul
                        ...
                        <Link
                            ...
                            spy = {true}
                            activeClass = "active"
                            className={`cursor-pointer font-['Work Sans'] font-medium text-xl leading-4 -tracking-[1%] px-4 py-3 rounded-full transition-all ${
                                isActive('home')
                        ...
                        <button onClick={toggleTheme} className={`cursor-pointer w-10 h-10 rounded-[50%] flex items-center justify-center ${isDark ? 'bg-black' : 'bg-white'}`}>
                            {isDark ? (
